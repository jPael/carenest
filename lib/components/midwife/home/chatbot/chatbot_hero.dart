...
import 'package:smartguide_app/pages/midwife/chatbot/chatbot_chat_page.dart';
        ...
        Hero(
          ...
          child: Container(
            ...
            child: OverflowBox(
              ...
              maxHeight: 250,
              maxWidth: 250,
              child: Image.asset("lib/assets/images/midwife_chatbot_icon.png", fit: BoxFit.contain),
            ),
          ),
        ),
        const SizedBox(
